...
VALUES (1, 'Formato indirizzo', '{firstname} {lastname}\r\n{company}\r\n{address_1}\r\n{address_2}\r\n{city}, {zone} {postcode}\r\n{country}');
...
VALUES (1, 1, 'Descrizione'),
       (2, 1, 'N. di core'),
       (3, 1, 'Velocità dell''orologio'),
       (4, 1, 'prova 1'),
       (5, 1, 'prova 2'),
       (6, 1, 'prova 3'),
       (7, 1, 'prova 4'),
...
VALUES (6, 'Prodotti HP', 1),
       (7, 'Presentazione della home page', 1),
       (8, 'Produttori', 1);
...
VALUES (79, 7, 1, 'iPhone6', 'index.php?route=product/product&amp;path=57&amp;product_id=49', 'catalog/demo/banners/iPhone6.jpg', 0),
...
VALUES (28, 1, 'Monitora', '', 'Monitora', '', ''),
       (33, 1, 'Fotocamere', '', 'Fotocamere', '', ''),
       (32, 1, 'Fotocamere Web', '', 'Fotocamere Web', '', ''),
       (31, 1, 'Scanner', '', 'Scanner', '', ''),
       (30, 1, 'Stampanti', '', 'Stampanti', '', ''),
       (29, 1, 'Mouse e trackball', '', 'Mouse e trackball', '', ''),
       (27, 1, 'Mac', '', 'Mac', '', ''),
       (26, 1, 'computer', '', 'computer', '', ''),
       (17, 1, 'Software', '', 'Software', '', ''),
       (25, 1, 'Componenti', '', 'Componenti', '', ''),
...
VALUES (1, 1, 'Afghanistan'),
       ...
       (25, 1, 'Bhutan'),
       (26, 1, 'Bolivia'),
       (27, 1, 'Bosnia ed Erzegovina'),
       (28, 1, 'Botswana'),
       (29, 1, 'Isola Bouvet'),
       (30, 1, 'Brasile'),
       (31, 1, 'Territorio britannico dell''Oceano Indiano'),
       (32, 1, 'Brunei'),
       (33, 1, 'Bulgaria'),
       (34, 1, 'Burkina Faso'),
       (35, 1, 'Burundi'),
       ...
       (39, 1, 'Capo Verde'),
       (40, 1, 'Isole Cayman'),
       (41, 1, 'Repubblica Centrafricana'),
       (42, 1, 'Chad'),
       (43, 1, 'Chile'),
       (44, 1, 'Cina'),
       (45, 1, 'Isola di Natale'),
       (46, 1, 'Isole Cocos (Keeling).'),
       (47, 1, 'Colombia'),
       (48, 1, 'Comore'),
       (49, 1, 'Congo'),
       (50, 1, 'Isole Cook'),
       ...
       (54, 1, 'Cuba'),
       (55, 1, 'Cipro'),
       (56, 1, 'Repubblica Ceca'),
       (57, 1, 'Danimarca'),
       (58, 1, 'Gibuti'),
       (59, 1, 'Dominica'),
       (60, 1, 'Repubblica Dominicana'),
       (61, 1, 'Timor Est'),
       (62, 1, 'Ecuador'),
       (63, 1, 'Egitto'),
       (64, 1, 'El Salvador'),
       (65, 1, 'Guinea Equatoriale'),
       (66, 1, 'Eritrea'),
       (67, 1, 'Estonia'),
       (68, 1, 'Etiopia'),
       (69, 1, 'Isole Falkland (Malvine)'),
       (70, 1, 'Isole Faroe'),
       (71, 1, 'Figi'),
       (72, 1, 'Finlandia'),
       (74, 1, 'Francia, metropolitana'),
       (75, 1, 'Guiana francese'),
       (76, 1, 'Polinesia francese'),
       (77, 1, 'Territori francesi del sud'),
       (78, 1, 'Gabon'),
       (79, 1, 'La Gambia'),
       (80, 1, 'Georgia'),
       (81, 1, 'Germania'),
       ...
       (99, 1, 'India'),
       (100, 1, 'Indonesia'),
       (101, 1, 'Iran (Repubblica islamica di)'),
       (102, 1, 'Iraq'),
       (103, 1, 'Irlanda'),
       (104, 1, 'Israele'),
       (105, 1, 'Italia'),
       ...
       (110, 1, 'Kenia'),
       (111, 1, 'Kiribati'),
       (112, 1, 'Corea del nord'),
       (113, 1, 'Corea del Sud'),
       (114, 1, 'Kuwait'),
       (115, 1, 'Kirghizistan'),
       (116, 1, 'Popolo laotiano''s Repubblica Democratica (la)'),
       (117, 1, 'Lettonia'),
       (118, 1, 'Libano'),
       (119, 1, 'Lesoto'),
       (120, 1, 'Liberia'),
       ...
       (131, 1, 'Mali'),
       (132, 1, 'Malta'),
       (133, 1, 'Isole Marshall'),
       (134, 1, 'Martinica'),
       (135, 1, 'La Mauritania'),
       (136, 1, 'Maurizio'),
       (137, 1, 'Mayotte'),
       (138, 1, 'Messico'),
       (139, 1, 'Micronesia, Stati Federati di'),
       (140, 1, 'Moldavia, Repubblica di'),
       (141, 1, 'Monaco'),
       (142, 1, 'Mongolia'),
       (143, 1, 'Montserrat'),
       (144, 1, 'Marocco'),
       ...
       (149, 1, 'Nepal'),
       (150, 1, 'Paesi Bassi'),
       (151, 1, 'Antille olandesi'),
       (152, 1, 'Nuova Caledonia'),
       (153, 1, 'Nuova Zelanda'),
       (154, 1, 'Nicaragua'),
       (155, 1, 'Niger'),
       (156, 1, 'Nigeria'),
       (157, 1, 'Niue'),
       (158, 1, 'Isola Norfolk'),
       (159, 1, 'Isole Marianne Settentrionali'),
       (160, 1, 'Norvegia'),
       (161, 1, 'Oman'),
       (162, 1, 'Pakistan'),
       (163, 1, 'Palau'),
       (164, 1, 'Panama'),
       (165, 1, 'Papua Nuova Guinea'),
       (166, 1, 'Paraguay'),
       (167, 1, 'Perù'),
       (168, 1, 'Filippine'),
       (169, 1, 'Pitcairn'),
       ...
       (174, 1, 'Riunione'),
       (175, 1, 'Romania'),
       (176, 1, 'Federazione Russa (la)'),
       (177, 1, 'Ruanda'),
       (178, 1, 'Saint Kitts e Nevis'),
       (179, 1, 'Santa Lucia'),
       (180, 1, 'Saint Vincent e Grenadine'),
       (181, 1, 'Samoa'),
       (182, 1, 'San Marino'),
       (183, 1, 'Sao Tomé e Principe'),
       (184, 1, 'Arabia Saudita'),
       (185, 1, 'Senegal'),
       (186, 1, 'Seychelles'),
       (187, 1, 'Sierra Leone'),
       (188, 1, 'Singapore'),
       (189, 1, 'Repubblica slovacca'),
       (190, 1, 'Slovenia'),
       (191, 1, 'Isole Salomone'),
       (192, 1, 'Somalia'),
       (193, 1, 'Sudafrica'),
...
VALUES ('-10% di sconto', '2222', 'P', '10.0000', 0, 0, '0.0000', '2014-01-01', '2020-01-01', 10, '10', 0, '2009-01-27 13:55:03'),
       ('Spedizione gratuita', '3333', 'P', '0.0000', 0, 1, '100.0000', '2014-01-01', '2014-02-01', 10, '10', 0, '2009-03-14 21:13:53'),
       ('-10.00 Sconto', '1111', 'F', '10.0000', 0, 0, '10.0000', '2014-01-01', '2020-01-01', 100000, '10000', 0, '2009-03-14 21:15:18');
...
VALUES ('currency', 'Aggiorna i valori di conversione della valuta.', 'day', 'cron/currency', 1, '2014-09-25 14:40:00', '2014-09-25 14:40:00'),
       ('gdpr', 'Elimina e invia e-mail ai clienti che hanno richiesto la cancellazione dei loro dati GPDR.', 'day', 'cron/gdpr', 1, '2014-09-25 14:40:00', '2014-09-25 14:40:00'),
       ('subscription', 'Elabora gli abbonamenti creando nuovi ordini, addebitando i clienti e inviando e-mail ai clienti che dicono loro che il loro abbonamento è stato elaborato.', 'day', 'cron/subscription', 0, '2014-09-25 14:40:00', '2014-09-25 14:40:00');
...
VALUES ('Sterlina britannica', 'GBP', '£', '', '2', 0.78065255, 1, '2014-09-25 14:40:00'),
       ('Dollaro americano', 'USD', '$', '', '2', 1.27453476, 1, '2014-09-25 14:40:00'),
       ('Euro', 'EUR', '', '€', '2', 1.00000000, 1, '2014-09-25 14:40:00'),
       ('Dollaro di Hong Kong', 'HKD', 'HK$', '', '2', 9.96971680, 0, '2018-02-16 12:00:00'),
       ('Rupia indiana', 'INR', '₹', '', '2', 82.08003869, 0, '2018-02-16 12:00:00'),
       ('Rublo russo', 'RUB', '', '₽', '2', 71.88834892, 0, '2018-02-16 12:00:00'),
       ('Yuan Renminbi cinese', 'CNY', '¥', '', '2', 8.08705052, 0, '2018-02-16 12:00:00'),
       ('Dollaro australiano', 'AUD', '$', '', '2', 1.61284727, 0, '2018-02-16 12:00:00');
...
VALUES (1, 1, 'Predefinito', 'Gruppo clienti predefinito'),
       (2, 1, 'Vedere al dettaglio', 'Clienti al dettaglio'),
       (3, 1, 'Commercio all''ingrosso', 'Clienti all''ingrosso');
...
VALUES (1, 1, 'Selezionare'),
       (2, 1, 'Radio'),
       (3, 1, 'Casella di controllo'),
       (4, 1, 'Testo'),
       (5, 1, 'Area di testo'),
       (6, 1, 'File'),
       (7, 1, 'Data'),
...
VALUES ('activity_customer_add', 'Aggiunge una nuova voce cliente nel registro attività.', 'catalog/model/account/customer.addCustomer/after', 'event/activity.addCustomer', 1),
       ('activity_customer_edit', 'Aggiunge la voce modifica cliente nel registro attività.', 'catalog/model/account/customer.editCustomer/after', 'event/activity.editCustomer', 1),
       ('activity_customer_password', 'Aggiunge la voce di modifica della password nel registro delle attività.', 'catalog/model/account/customer.editPassword/after', 'event/activity.editPassword', 1),
       ('activity_customer_forgotten', 'Aggiunge l''immissione della password dimenticata nel registro delle attività.', 'catalog/model/account/customer.addToken/after', 'event/activity.forgotten', 1),
       ('activity_customer_login', 'Aggiunge la voce modifica cliente nel registro attività.', 'catalog/model/account/customer.deleteLoginAttempts/after', 'event/activity.login', 1),
       ('activity_customer_transaction', 'Aggiunge la voce modifica cliente nel registro attività.', 'catalog/model/account/customer.addTransaction/after', 'event/activity.addTransaction', 1),
       ('activity_address_add', 'Aggiunge una nuova voce di indirizzo nel registro attività.', 'catalog/model/account/address.addAddress/after', 'event/activity.addAddress', 1),
       ('activity_address_edit', 'Aggiunge la voce di modifica dell''indirizzo nel registro delle attività.', 'catalog/model/account/address.editAddress/after', 'event/activity.editAddress', 1),
       ('activity_address_delete', 'Aggiunge la voce di eliminazione dell''indirizzo nel registro attività.', 'catalog/model/account/address.deleteAddress/after', 'event/activity.deleteAddress', 1),
       ('activity_affiliate_add', 'Aggiunge una nuova voce di affiliazione nel registro delle attività.', 'catalog/model/account/affiliate.addAffiliate/after', 'event/activity.addAffiliate', 1),
       ('activity_affiliate_edit', 'Aggiunge la voce di modifica dell''affiliato nel registro delle attività.', 'catalog/model/account/affiliate.editAffiliate/after', 'event/activity.editAffiliate', 1),
       ('activity_order_add', 'Aggiunge una nuova voce d''ordine nel registro delle attività.', 'catalog/model/checkout/order.addHistory/before', 'event/activity.addHistory', 1),
       ('activity_return_add', 'Aggiunge una nuova voce di ritorno nel registro delle attività.', 'catalog/model/account/returns.addReturn/after', 'event/activity.addReturn', 1),
       ('mail_customer_add', 'Invia posta ai nuovi clienti registrati.', 'catalog/model/account/customer.addCustomer/after', 'mail/register', 1),
       ('mail_customer_alert', 'Invia una mail di avviso al proprietario del negozio quando un nuovo cliente si registra.', 'catalog/model/account/customer.addCustomer/after', 'mail/register.alert', 1),
       ('mail_customer_transaction', 'Invia posta al cliente quando il saldo della transazione viene aggiornato.', 'catalog/model/account/customer.addTransaction/after', 'mail/transaction', 1),
       ('mail_customer_forgotten', 'Invia posta ai clienti che hanno dimenticato la password.', 'catalog/model/account/customer.addToken/after', 'mail/forgotten', 1),
       ('mail_customer_authorize', 'Invia il codice di accesso all''e-mail dei clienti per autorizzare l''accesso da un nuovo dispositivo.', 'catalog/controller/account/authorize.send/after', 'mail/authorize', 1),
       ('mail_customer_authorize_reset', 'Invia il link di ripristino all''utente il cui account è bloccato dopo 3 tentativi di accesso con codice di autorizzazione errato.', 'catalog/model/account/customer.addToken/after', 'mail/authorize.reset', 1),
       ('mail_affiliate_add', 'Invia posta agli affiliati appena registrati.', 'catalog/model/account/affiliate.addAffiliate/after', 'mail/affiliate', 1),
       ('mail_affiliate_alert', 'Invia posta a nuovi clienti.', 'catalog/model/account/affiliate.addAffiliate/after', 'mail/affiliate.alert', 1),
       ('mail_order', 'Invia la posta al cliente quando effettua un ordine.', 'catalog/model/checkout/order.addHistory/before', 'mail/order', 1),
       ('mail_order_alert', 'Invia una mail di avviso al nuovo proprietario del negozio quando viene effettuato un nuovo ordine.', 'catalog/model/checkout/order.addHistory/before', 'mail/order.alert', 1),
       ('mail_gdpr', 'Invia la posta ai clienti che hanno richiesto l''esportazione o l''eliminazione dei propri dati.', 'catalog/model/account/gdpr.addGdpr/after', 'mail/gdpr', 1),
       ('mail_gdpr_delete', 'Invia e-mail ai clienti per informarli che i loro dati GDPR sono stati eliminati.', 'catalog/model/account/gdpr.editStatus/after', 'mail/gdpr.remove', 1),
       ('mail_review', 'Invia una mail al proprietario del negozio comunicando che è stata inviata una nuova recensione.', 'catalog/model/catalog/review.addReview/after', 'mail/review', 1),
       ('mail_subscription', 'Invia una mail al proprietario del negozio per comunicare che è stato creato un nuovo abbonamento.', 'catalog/model/checkout/subscription.addSubscription/after', 'mail/subscription', 1),
       ('statistics_review_add', 'Aggiorna le statistiche delle recensioni quando ne viene aggiunta una nuova.', 'catalog/model/catalog/review.addReview/after', 'event/statistics.addReview', 1),
       ('statistics_return_add', 'Aggiorna le statistiche di reso quando viene aggiunto un nuovo reso.', 'catalog/model/account/returns.addReturn/after', 'event/statistics.addReturn', 1),
       ('statistics_return_delete', 'Aggiorna le statistiche di reso quando un reso viene eliminato.', 'admin/model/sale/returns.deleteReturn/after', 'event/statistics.deleteReturn', 1),
       ('statistics_order_history', 'Aggiorna le statistiche sullo stato dell''ordine quando un ordine è stato aggiornato.', 'catalog/model/checkout/order.addHistory/before', 'event/statistics.addHistory', 1),
       ('admin_currency_add', 'Aggiorna le valute quando viene aggiunta una nuova valuta.', 'admin/model/localisation/currency.addCurrency/after', 'event/currency', 1),
       ('admin_currency_edit', 'Aggiorna le valute quando una valuta viene modificata.', 'admin/model/localisation/currency.editCurrency/after', 'event/currency', 1),
       ('admin_currency_setting', 'Aggiorna le valute quando vengono salvate le impostazioni.', 'admin/model/setting/setting.editSetting/after', 'event/currency', 1),
       ('admin_mail_gdpr', 'Invia e-mail di approvazione o rifiuto al cliente che ha richiesto l''esportazione o l''eliminazione dei dati GDPR.', 'admin/model/customer/gdpr.editStatus/after', 'mail/gdpr', 1),
       ('admin_mail_affiliate_approve', 'Invia posta all''affiliato quando il suo account viene approvato.', 'admin/model/customer/customer_approval.approveAffiliate/after', 'mail/affiliate.approve', 1),
       ('admin_mail_affiliate_deny', 'Invia una mail all''affiliato quando il suo account viene negato.', 'admin/model/customer/customer_approval.denyAffiliate/after', 'mail/affiliate.deny', 1),
       ('admin_mail_customer_approve', 'Invia posta al cliente quando il suo account viene approvato.', 'admin/model/customer/customer_approval.approveCustomer/after', 'mail/customer.approve', 1),
       ('admin_mail_customer_deny', 'Invia posta al cliente quando il suo account viene negato.', 'admin/model/customer/customer_approval.denyCustomer/after', 'mail/customer.deny', 1),
       ('admin_mail_customer_transaction', 'Invia posta al cliente quando il saldo della transazione viene aggiornato.', 'admin/model/customer/customer.addTransaction/after', 'mail/transaction', 1),
       ('admin_mail_reward', 'Invia una mail al cliente quando il saldo delle ricompense viene aggiornato.', 'admin/model/customer/customer.addReward/after', 'mail/reward', 1),
       ('admin_mail_return', 'Invia posta al cliente quando il suo stato di reso viene modificato.', 'admin/model/sale/returns.addHistory/after', 'mail/returns', 1),
       ('admin_mail_user_forgotten', 'Invia posta agli utenti che hanno dimenticato la password.', 'admin/model/user/user.addToken/after', 'mail/forgotten', 1),
       ('admin_mail_user_authorize', 'Invia il codice di accesso e-mail agli utenti per autorizzare l''accesso da un nuovo dispositivo.', 'admin/controller/common/authorize.send/after', 'mail/authorize', 1),
       ('admin_mail_user_authorize_reset', 'Invia il link di ripristino all''utente il cui account è bloccato dopo 3 tentativi di accesso con codice di autorizzazione errato.', 'admin/model/user/user.addToken/after', 'mail/authorize.reset', 1);
...
VALUES (1, 0, 0, 'OpenCart Default Extensions', 'Questa estensione contiene tutte le estensioni predefinite per moduli, valute, metodi di pagamento, metodi di spedizione, antifrode, temi, totali degli ordini e report.', 'opencart', '1.0', 'OpenCart Ltd', 'http://www.opencart.com', 1, '2020-08-29 15:35:39');
...
VALUES (1, 'opencart'),
       ...
       (1, 'opencart/admin/language/it-it'),
       (1, 'opencart/admin/language/it-it/captcha'),
       (1, 'opencart/admin/language/it-it/captcha/basic.php'),
       (1, 'opencart/admin/language/it-it/currency'),
       (1, 'opencart/admin/language/it-it/currency/ecb.php'),
       (1, 'opencart/admin/language/it-it/currency/fixer.php'),
       (1, 'opencart/admin/language/it-it/dashboard'),
       (1, 'opencart/admin/language/it-it/dashboard/activity.php'),
       (1, 'opencart/admin/language/it-it/dashboard/chart.php'),
       (1, 'opencart/admin/language/it-it/dashboard/customer.php'),
       (1, 'opencart/admin/language/it-it/dashboard/map.php'),
       (1, 'opencart/admin/language/it-it/dashboard/online.php'),
       (1, 'opencart/admin/language/it-it/dashboard/order.php'),
       (1, 'opencart/admin/language/it-it/dashboard/recent.php'),
       (1, 'opencart/admin/language/it-it/dashboard/sale.php'),
       (1, 'opencart/admin/language/it-it/fraud'),
       (1, 'opencart/admin/language/it-it/fraud/ip.php'),
       (1, 'opencart/admin/language/it-it/module'),
       (1, 'opencart/admin/language/it-it/module/account.php'),
       (1, 'opencart/admin/language/it-it/module/banner.php'),
       (1, 'opencart/admin/language/it-it/module/bestseller.php'),
       (1, 'opencart/admin/language/it-it/module/category.php'),
       (1, 'opencart/admin/language/it-it/module/featured.php'),
       (1, 'opencart/admin/language/it-it/module/filter.php'),
       (1, 'opencart/admin/language/it-it/module/html.php'),
       (1, 'opencart/admin/language/it-it/module/information.php'),
       (1, 'opencart/admin/language/it-it/module/latest.php'),
       (1, 'opencart/admin/language/it-it/module/special.php'),
       (1, 'opencart/admin/language/it-it/module/store.php'),
       (1, 'opencart/admin/language/it-it/payment'),
       (1, 'opencart/admin/language/it-it/payment/bank_transfer.php'),
       (1, 'opencart/admin/language/it-it/payment/cheque.php'),
       (1, 'opencart/admin/language/it-it/payment/cod.php'),
       (1, 'opencart/admin/language/it-it/payment/free_checkout.php'),
       (1, 'opencart/admin/language/it-it/report'),
       (1, 'opencart/admin/language/it-it/report/customer.php'),
       (1, 'opencart/admin/language/it-it/report/customer_activity.php'),
       (1, 'opencart/admin/language/it-it/report/customer_order.php'),
       (1, 'opencart/admin/language/it-it/report/customer_reward.php'),
       (1, 'opencart/admin/language/it-it/report/customer_search.php'),
       (1, 'opencart/admin/language/it-it/report/subscription.php'),
       (1, 'opencart/admin/language/it-it/report/customer_transaction.php'),
       (1, 'opencart/admin/language/it-it/report/marketing.php'),
       (1, 'opencart/admin/language/it-it/report/product_purchased.php'),
       (1, 'opencart/admin/language/it-it/report/product_viewed.php'),
       (1, 'opencart/admin/language/it-it/report/sale_coupon.php'),
       (1, 'opencart/admin/language/it-it/report/sale_order.php'),
       (1, 'opencart/admin/language/it-it/report/sale_return.php'),
       (1, 'opencart/admin/language/it-it/report/sale_shipping.php'),
       (1, 'opencart/admin/language/it-it/report/sale_tax.php'),
       (1, 'opencart/admin/language/it-it/shipping'),
       (1, 'opencart/admin/language/it-it/shipping/flat.php'),
       (1, 'opencart/admin/language/it-it/shipping/free.php'),
       (1, 'opencart/admin/language/it-it/shipping/item.php'),
       (1, 'opencart/admin/language/it-it/shipping/pickup.php'),
       (1, 'opencart/admin/language/it-it/shipping/weight.php'),
       (1, 'opencart/admin/language/it-it/theme'),
       (1, 'opencart/admin/language/it-it/theme/basic.php'),
       (1, 'opencart/admin/language/it-it/total'),
       (1, 'opencart/admin/language/it-it/total/coupon.php'),
       (1, 'opencart/admin/language/it-it/total/credit.php'),
       (1, 'opencart/admin/language/it-it/total/handling.php'),
       (1, 'opencart/admin/language/it-it/total/low_order_fee.php'),
       (1, 'opencart/admin/language/it-it/total/reward.php'),
       (1, 'opencart/admin/language/it-it/total/shipping.php'),
       (1, 'opencart/admin/language/it-it/total/sub_total.php'),
       (1, 'opencart/admin/language/it-it/total/tax.php'),
       (1, 'opencart/admin/language/it-it/total/total.php'),
       ...
       (1, 'opencart/catalog/language/it-it'),
       (1, 'opencart/catalog/language/it-it/captcha'),
       (1, 'opencart/catalog/language/it-it/captcha/basic.php'),
       (1, 'opencart/catalog/language/it-it/module'),
       (1, 'opencart/catalog/language/it-it/module/account.php'),
       (1, 'opencart/catalog/language/it-it/module/bestseller.php'),
       (1, 'opencart/catalog/language/it-it/module/category.php'),
       (1, 'opencart/catalog/language/it-it/module/featured.php'),
       (1, 'opencart/catalog/language/it-it/module/filter.php'),
       (1, 'opencart/catalog/language/it-it/module/information.php'),
       (1, 'opencart/catalog/language/it-it/module/latest.php'),
       (1, 'opencart/catalog/language/it-it/module/special.php'),
       (1, 'opencart/catalog/language/it-it/module/store.php'),
       (1, 'opencart/catalog/language/it-it/payment'),
       (1, 'opencart/catalog/language/it-it/payment/bank_transfer.php'),
       (1, 'opencart/catalog/language/it-it/payment/cheque.php'),
       (1, 'opencart/catalog/language/it-it/payment/cod.php'),
       (1, 'opencart/catalog/language/it-it/payment/free_checkout.php'),
       (1, 'opencart/catalog/language/it-it/shipping'),
       (1, 'opencart/catalog/language/it-it/shipping/flat.php'),
       (1, 'opencart/catalog/language/it-it/shipping/free.php'),
       (1, 'opencart/catalog/language/it-it/shipping/item.php'),
       (1, 'opencart/catalog/language/it-it/shipping/pickup.php'),
       (1, 'opencart/catalog/language/it-it/shipping/weight.php'),
       (1, 'opencart/catalog/language/it-it/total'),
       (1, 'opencart/catalog/language/it-it/total/coupon.php'),
       (1, 'opencart/catalog/language/it-it/total/credit.php'),
       (1, 'opencart/catalog/language/it-it/total/handling.php'),
       (1, 'opencart/catalog/language/it-it/total/low_order_fee.php'),
       (1, 'opencart/catalog/language/it-it/total/reward.php'),
       (1, 'opencart/catalog/language/it-it/total/shipping.php'),
       (1, 'opencart/catalog/language/it-it/total/sub_total.php'),
       (1, 'opencart/catalog/language/it-it/total/total.php'),
...
VALUES (3, 'Zona IVA Italia', 'IVA Italiana'),
       (4, 'Spedizione in Italia', 'Zone di spedizione in Italia');
...
VALUES (1, 1, 'Chi siamo', '&lt;p&gt;\r\n	Chi siamo&lt;/p&gt;\r\n', 'Chi siamo', '', ''),
       (2, 1, 'Termini &amp; Condizioni', '&lt;p&gt;\r\n	Termini &amp;amp; Condizioni&lt;/p&gt;\r\n', 'Termini &amp; Condizioni', '', ''),
       (3, 1, 'Privacy Policy', '&lt;p&gt;\r\n	Privacy Policy&lt;/p&gt;\r\n', 'Privacy Policy', '', ''),
       (4, 1, 'Spedizioni', '&lt;p&gt;\r\n	Informazioni sulle spedizioni&lt;/p&gt;\r\n', 'Spedizioni', '', '');
...
VALUES (1, 'Italiano', 'it-it', 'it_IT,italian', 1, 1);
...
VALUES (43, 1, 1, 'Grande'),
       (32, 1, 1, 'Piccolo'),
       (45, 1, 2, 'Casella di controllo 4'),
       (44, 1, 2, 'Casella di controllo 3'),
       (31, 1, 1, 'Medio'),
       (42, 1, 5, 'Giallo'),
       (41, 1, 5, 'Verde'),
       (39, 1, 5, 'Rosso'),
       (40, 1, 5, 'Blu'),
       (23, 1, 2, 'Casella di controllo 1'),
       (24, 1, 2, 'Casella di controllo 2'),
       (48, 1, 11, 'Grande'),
       (47, 1, 11, 'Medio'),
       (46, 1, 11, 'Piccolo');
...
VALUES (2, 1, 'Elaborazione'),
       (3, 1, 'Spedito'),
       (7, 1, 'Annullato'),
       (5, 1, 'Completare'),
       (8, 1, 'Negato'),
       (9, 1, 'Inversione annullata'),
       (10, 1, 'Fallito'),
       (11, 1, 'Rimborsato'),
       (12, 1, 'Invertito'),
       (13, 1, 'Riaddebito'),
...
VALUES (1, 1, 'In attesa del ritorno'),
       (2, 1, 'Credito emesso'),
       (3, 1, 'Sostituzione inviata'),
       (4, 1, 'Rimborsato');
...
VALUES (1, 1, 'Morto all''arrivo'),
       (2, 1, 'Articolo sbagliato ricevuto'),
       (3, 1, 'Errore nell''ordine'),
       (4, 1, 'Difettoso, fornire i dettagli'),
       (5, 1, 'Altro, si prega di fornire dettagli');
...
VALUES (1, 1, 'In attesa di'),
       (3, 1, 'Completare'),
       (2, 1, 'In attesa di prodotti');
...
VALUES (0, 'config', 'config_shared', '0', 0),
       ...
       (0, 'config', 'config_country_id', '105', 0),
       (0, 'config', 'config_zone_id', '3924', 0),
       (0, 'config', 'config_timezone', 'UTC', 0),
       (0, 'config', 'config_language_catalog', 'it-it', 0),
       (0, 'config', 'config_language_admin', 'it-it', 0),
...
VALUES (9, 'Beni imponibili', 'Beni tassati'),
       (10, 'Prodotti scaricabili', 'Scaricabile');
